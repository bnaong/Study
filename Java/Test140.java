...
○ StringTokenizer 클래스는
	...
	StringTokenizer 클래스는 호환성을 유지하는 목적(가급적이면 쓰지않는게 좋겠다으로 제거되지 않고
...
○ 생성자
	...
	- 원형
	  ...
	  StringTokenizer(String str, String delim) --> 구분자가 문자열 형태로
...
public class Test140
{
	public static void main(String[] args) throws IOException
	{
		...
		//		 4
		//-- StringTokenizer의 『int countTokens()』 메소드
		...
		// hasMoreTokens() 는 다음 값이 있는지 없는지 true, false로 반환
		// hasMoreTokens()와 nextToken()은 함께 일함
		...
		//	   확인에 대한 결과만 반환할 뿐 실제 내용을 읽어 들이지 않고,
