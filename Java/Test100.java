...
public class Test100
{
	...
	//	  사용이 가능하다는 것이다.
		...
		public static void main(String[] args)
		{
			...
			//--==>> main() 메소드 -> 클래스 변수 a : 10
			// 변수와 메소드 둘다 스태틱이고 같은 클래스 안에 있으면 가능
			...
			//System.out.println("main() 메소드 -> 인스턴스 변수 b : " + b); //--인스턴스를 통해서만 접근가능
			//System.out.println("main() 메소드 -> 인스턴스 변수 b : " + Test100.b); //--인스턴스를 통해서만 접근가능
			...
			ob.write();
			//--==>> 인스턴스메소드 -> 클래스변수 a : 10000			//-- a는 스테이플러 개념(공유)
			//		 인스턴스메소드 -> 인스턴스변수 b : 20			//-- b는 딱풀(개인 것)
