...
public class Test170
{
	...
	public static void main(String[] args)
	{
		...
		//}
		System.out.println();
		//--==>> 김동민 전화번호 : 010-1461-5173
		


		// ht 라는 Hashtable 자료구조에
		// key 가 존재하는지의 여부 확인
		// -> containsKey() 메소드 사용 -> true, false 반환
		...
		// -> contains() 메소드 사용
		String findTel1 = "010-1234-5678";		// 경태 전화번호
		...
		System.out.println();
		//--==>> 010-1234-5678 데이터가 존재합니다.

		// ht 라는 Hashtable 구조에서
		// 『길현욱』 데이터 삭제
		// -> remove() 메소드 사용
		...
		//	  해당 key와 연결되어(매핑되어) 있는 value 도 함께 제거한다.
		...
		//--==>> 에러 발생(런타임 에러) java.lang.NullPointerException
		// Hashtable은 null을 허용하지 않음

		
		//ht.put("김수환",null);			//-- value 가 null 인 상태
		//--==>> 에러 발생(런타임 에러) java.lang.NullPointerException

		//ht.put(null, "010-2376-8232");	//-- key 가 null 인 상태
		//--==>> 에러 발생(런타임 에러) java.lang.NullPointerException
		...
		//   기존에 입력한 전화번호에서 새로운 전화번호로 변경되었음을 확인
		//   (덮어쓰기 개념)

		// 중복된 value 입력
		ht.put("김지민","010-1234-5678");

		System.out.println(ht.get("김경태"));
