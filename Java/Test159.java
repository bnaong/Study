...
//-- 8개의 초기 element를 가진 Vector 자료구조 v 생성
...
//    담아내는 것이 가능하다. (-> 가능해졌다.)
//	  -> 데이터 안정성을 확보해가면서 사용해야 한다!(벡터뿐만 아니라 컬렉션에서 쓰는 것들도)
...
class MyVector extends Vector<Object>
{
	...
	void write()
	{
		...
		*/
		...
		//『instanceof』 연산자 
		// Vector 에서 특정한 요소를 꺼내 쓸 때 처리해야 하는 대상의 객체 타입(유형) 확인
		...
		for (int i=0; i<length ; i++ )
		{
			o = elementAt(i);			//this. , super. 다 가능하다.
