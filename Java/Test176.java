...
public class Test176
{
	...
	{	
		...
		try
		{
			// 매개변수 is 라는 바이트 기반의 객체(InputStream)를
			// 문자 스트림으로 변환하여 (->InputStreamReader 가 역할 수행)
			// Reader 타입의 rd 에서 참조할 수 있도록 처리

			Reader rd = new InputStreamReader(is);			//-- 문자기반 입력 스트림 rd
			//								  --
			//							바이트기반 스트림
			//				---------------------
			//				  문자 기반 스트림
			...
			Writer wt = new OutputStreamWriter(System.out);	//-- 문자기반 출력 스트림 wt
