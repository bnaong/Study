...
○ java.lang.Math 클래스의 주요 상수 및 메소드
	...
	- public static dobule sqrt(double a)
	: a 의 제곱근을 구하여 반환한다.
	...
	- pulbic static long round(double a)
	: a 를 반올림 하여 결과값을 반환한다.
...
public class Test145
{
	public static void main(String[] args)
	{
		...
		System.out.println("파이에 대한 Drgree : " + Math.toDegrees(Math.PI));
		...
		//--==>> 0.0~1.0 사이의 난수 : 0.9241607500955696
		//		 0.0~1.0 사이의 난수 : 0.3803803758569594
		//	     0.0~1.0 사이의 난수 : 0.5887850524800078
		//		 0.0~1.0 사이의 난수 : 0.29544252538559357
