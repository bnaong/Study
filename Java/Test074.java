...
class NumberTest
{
	...
	/*					
	NumberTest()				//-- 디폴트(default) 생성자 -> 사용자 정의 생성자가 존재하지 않을 때 컴파일 과정에서 자동으로 삽입
	{
		// 텅 비어있음~!!!
	}
	*/
	...
	{
		num = 1;
		System.out.println("사용자 정의 생성자 호출~!!!");		//-- 인스턴스 생성만으로 출력 가능
	}
...
public class Test074
{
	public static void main(String[] args)
	{
		...
		//--==>> 사용자 정의 생성자 호출~!!!
		//-- 인스턴스가 생성되는 시점에서 이와 동시에 선택의 여지 없이 생성자 호출이 이루어진다
		//															   ------------
		//																NumberTest();
