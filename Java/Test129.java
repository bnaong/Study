...
public class Test129
{
	public static void main(String[] args)
	{
		...
		// equals()
		System.out.println("1-1 : " + nCar1.equals(nCar2));		//-- 객체의 주소값으로 비교
		...
		//--==>> 3-1 : NewCar@15db9742 (16진수 형태의 주소값)
		//		 3-2 : NewCar@6d06d69c
		//		 3-3 : NewCar@15db9742
		...
		//		 5-2 : class NewCar
		//		 5-3 : class NewCar
		//-- 생성된 객체를 통해 해당 객체의 기반 설계도(클래스)를 확인할 수 있는 기능을 가진 메소드
