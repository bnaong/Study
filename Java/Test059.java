...
public class Test059
{
	...
	{
		// 1) Test058과 비교하여
		// 출력 방향(출력 순서)가 다르기 때문에
		// 반복문의 제어 흐름도 달라져야 한다.
		// (한 방향으로 처리 되는 콘솔 기반의 출력 환경이기 때문에...)
		...
		for (k=0;k<=4;k+=4)
		{
			for (i=1;i<=9;i++)
			{
				for (j=2;j<=5;j++)
				{
					...
					System.out.printf("%2d *%2d = %2d  ",(j+k), i, (j+k)*i);
