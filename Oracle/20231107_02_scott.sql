...
H001	바밤바	600	    30
H002	죠스바	500	    30
H003	보석바	500	    20         ← 테스트할 항목(재고 35개 -> 15개 출고 -> 재고 20개)
H004	누가바	600	    70
H005	쌍쌍바	700	    0
H006	수박바	500	    0
H007	알껌바	500	    0
...
5	H003	2023-11-06	35	400         ← 테스트할 항목
...
10	H003	2023-11-06	15	500         ← 테스트할 항목
*/


--○ 생성한 프로시저가 제대로 작동하는 지의 여부 확인 -> 프로시저 호출
...
INSERT 쿼리가 실행되었습니다.	2023-11-07 16:15:08
INSERT 쿼리가 실행되었습니다.	2023-11-07 16:17:18
UPDATE 쿼리가 실행되었습니다.	2023-11-07 16:18:48
DELETE 쿼리가 실행되었습니다.	2023-11-07 16:19:29
DELETE 쿼리가 실행되었습니다.	2023-11-07 16:20:22
*/
...
ROLLBACK;
-- TRUNCATE : 테이블을 가위로 오려내는 것... 롤백이 안됨(AUTO COMMIT임)
