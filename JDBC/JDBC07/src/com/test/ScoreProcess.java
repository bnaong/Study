...
public class ScoreProcess
{
	...
	public void scoreSelect()
	{
		try
		{
			...
			{
				System.out.printf("%3s %5s %5d %5d %6d %7d %6.1f %5d\n"
	...
	public void scoreSearchSelect()
	{
		try
		{
			...
			ArrayList<ScoreDTO> arrayList = dao.nameSearch(name);
	...
	public void scoreUpdate()
	{
		try
		{
			...
			ArrayList<ScoreDTO> arrayList = dao.sidSearch(sid);
