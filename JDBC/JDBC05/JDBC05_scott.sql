...
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES(JIKWISEQ.NEXTVAL, '과장', 2260000);
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES(JIKWISEQ.NEXTVAL, '대리', 1800000);
INSERT INTO TBL_JIKWI(JIKWI_ID, JIKWI_NAME, MIN_BASICPAY)
VALUES(JIKWISEQ.NEXTVAL, '사원', 1650000);
--==>> 1 행 이(가) 삽입되었습니다. * 9
...
--○ 실습 테이블 생성
-- 사원 이름 주민번호 입사일 지역 전화번호 부서 직위 기본급 수당
...
-- 날짜 타입은 DB상에서 세션이 다를 수 있으므로 TO_CHAR을 이용하여 가져오고자 하는 형태로 만들어야함
...
SET EMP_NAME='김경태', SSN='990511-1234567'
  ...
  , JIKWI_ID=(SELECT JIKWI_ID FROM TBL_JIWKI WHERE JIKWI_NAME='과장')
  , BASICPAY=3000000
  , SUDANG=1000000
WHERE EMP_ID='1061';
--> 한 줄 구성
...
--○ 데이터 입력문
INSERT INTO TBL_EMP (EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '박나영', '990208-2234567', '2023-11-23', (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '경북'), '010-1234-8765', (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '개발부'), (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '대리'), 900000 , 102000)
;

--○ 전체 출력문(사번정렬)
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, BASICPAY+SUDANG AS SAL FROM TBL_EMP E JOIN TBL_CITY C ON E.CITY_ID = C.CITY_ID JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID ORDER BY EMP_ID
;


--○ 전체 출력문(이름정렬)
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, BASICPAY+SUDANG AS SAL FROM TBL_EMP E JOIN TBL_CITY C ON E.CITY_ID = C.CITY_ID JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID ORDER BY EMP_NAME
;

--○ 전체 출력문(부서정렬)
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, BASICPAY+SUDANG AS SAL FROM TBL_EMP E JOIN TBL_CITY C ON E.CITY_ID = C.CITY_ID JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID ORDER BY BUSEO_NAME
;

--○ 전체 출력문(직위정렬)
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, BASICPAY+SUDANG AS SAL FROM TBL_EMP E JOIN TBL_CITY C ON E.CITY_ID = C.CITY_ID JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID ORDER BY JIKWI_NAME
;
--○ 전체 출력문(급여내림차순정렬)
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG, BASICPAY+SUDANG AS SAL FROM TBL_EMP E JOIN TBL_CITY C ON E.CITY_ID = C.CITY_ID JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID ORDER BY BASICPAY+SUDANG DESC
;
...
--○ 최소 기본급 출력문
SELECT MIN_BASICPAY FROM TBL_JIKWI WHERE JIKWI_NAME = '사원'
;

--○ 사번 검색 출력문
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, C.CITY_NAME, E.TEL, B.BUSEO_NAME, J.JIKWI_NAME, E.BASICPAY, E.SUDANG
FROM TBL_EMP E JOIN TBL_CITY C
ON E.CITY_ID = C.CITY_ID
JOIN TBL_BUSEO B
ON E.BUSEO_ID = B.BUSEO_ID
JOIN TBL_JIKWI J
ON E.JIKWI_ID = J.JIKWI_ID WHERE EMP_ID = 1001
;

--○ 이름 검색 출력문
SELECT EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG FROM TBL_EMP WHERE EMP_NAME = '홍길동'
;

--○ 부서 검색 출력문
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, E.CITY_ID, E.TEL, B.BUSEO_ID, E.JIKWI_ID, E.BASICPAY, E.SUDANG FROM TBL_EMP E JOIN TBL_BUSEO B ON E.BUSEO_ID = B.BUSEO_ID WHERE BUSEO_NAME = '개발부'
;

--○ 직위 검색 출력문
SELECT E.EMP_ID, E.EMP_NAME, E.SSN, E.IBSADATE, E.CITY_ID, E.TEL, E.BUSEO_ID, J.JIKWI_ID, E.BASICPAY, E.SUDANG FROM TBL_EMP E JOIN TBL_JIKWI J ON E.JIKWI_ID = J.JIKWI_ID WHERE JIKWI_NAME = '사원'
;
...
--○ 데이터 수정문
UPDATE TBL_EMP SET EMP_NAME = '박나영', SSN = '810809-1222222', IBSADATE = '2000-01-01', CITY_ID = (SELECT CITY_ID FROM TBL_CITY WHERE CITY_NAME = '경기'), TEL = '010-6666-7777', BUSEO_ID = (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME = '홍보부'), JIKWI_ID = (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME = '사원'), BASICPAY = 1000000, SUDANG = 103000 WHERE EMP_ID = 1063
;
