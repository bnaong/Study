...
%>
<%
	// 이전 페이지(Article.jsp)로부터 넘어온 데이터 수신 → num, pageNum
	...
	<form action="" method="post" name="myForm">
		<div id="bbsCreated">
			...
			<div class="bbsCreated_bottomLine">
				<dl>
					...
					<dd>
						...
						{
						%>
						<input type="text" name="name" size="35" maxlength="20" class="boxTF" value="<%=dto.getName()%>" disabled="disabled">
						<%
						}
						%>
					</dd>
			...
			<div class="bbsCreated_noLine">
				<dl>
					...
					<dd>
						...
						<input type="password" name="pwd" size="35" id="pwd" maxlength="10" class="boxTF" >
			...
			<div id="bbsCreated_footer">
				...
				<input type="button" value="작성취소" class="btn2" onclick="javascript:location.href='<%=cp%>/List.jsp?pageNum=<%=pageNum %>'">
				<%
				}
				else					// status==2 → 삭제 액션 요청
				{
