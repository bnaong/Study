...
<%
	// 이전 페이지(MemberScoreSelect.jsp)로부터 넘어온 데이터 수신 → sid
	...
	try
	{
		...
		// 수신한 데이터를 활용하여 name 및 각 과목의 점수 얻어내기
...
<div>
	<h1>회원 <span style="color: red;">성적</span> 관리 및 <span style="color: green;">수정</span> 페이지</h1>
	<hr>
</div>
